...
from app.database.schemas import UserCreate, UserResponse, Token, TokenData
...
def get_password_hash(password: str) -> str:
    print("Debug: Getting password hash")
...
# /me endpoint to return the current user's information
